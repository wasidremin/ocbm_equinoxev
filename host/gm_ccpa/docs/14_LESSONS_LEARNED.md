...
- `versionCode` is **not** `git rev-list --count HEAD` on this shallow mirror (that is 8). Play has already consumed 8–14 and 20–46. **High-water mark: versionCode 46** (`4.0+fit`, 2026-09-24, `automotive:internal` COMPLETED). Next Play upload must be **> 46**; a reuse is refused with `403 Version code N has already been used.`
