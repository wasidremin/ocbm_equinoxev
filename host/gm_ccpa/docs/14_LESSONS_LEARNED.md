...
- `versionCode` is **not** `git rev-list --count HEAD` on this shallow mirror (that is 8). Play has already consumed 8–14 and 20–47. **High-water mark: versionCode 47** (`4.0+still`, 2026-09-24, `automotive:internal` COMPLETED). Next Play upload must be **> 47**; a reuse is refused with `403 Version code N has already been used.`
