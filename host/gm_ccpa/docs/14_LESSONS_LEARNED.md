...
- `versionCode` is **not** `git rev-list --count HEAD` on this shallow mirror (that is 8). Play has already consumed 8–14 and 20–49. **High-water mark: versionCode 49** (`4.0+mirror`, 2026-09-25, `automotive:internal` COMPLETED). Next Play upload must be **> 49**; a reuse is refused with `403 Version code N has already been used.`
