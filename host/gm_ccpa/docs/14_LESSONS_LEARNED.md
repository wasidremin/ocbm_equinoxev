...
- `versionCode` is **not** `git rev-list --count HEAD` on this shallow mirror (that is 8). Play has already consumed 8–14 and 20–50. **High-water mark: versionCode 50** (`4.0+hold`, 2026-09-25, `automotive:internal` COMPLETED). Next Play upload must be **> 50**; a reuse is refused with `403 Version code N has already been used.`
