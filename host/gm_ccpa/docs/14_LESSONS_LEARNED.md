...
- `versionCode` is **not** `git rev-list --count HEAD` on this shallow mirror (that is 8). Play has already consumed 8–14 and 20–51. **High-water mark: versionCode 51** (`4.0+return`, 2026-09-26, `automotive:internal` COMPLETED). Next Play upload must be **> 51**; a reuse is refused with `403 Version code N has already been used.`
