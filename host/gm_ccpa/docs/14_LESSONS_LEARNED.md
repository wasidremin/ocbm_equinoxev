...
- `versionCode` is **not** `git rev-list --count HEAD` on this shallow mirror (that is 8). Play has already consumed 8–14 and 20–42. **High-water mark: versionCode 43** (`4.0+audio`, 2026-09-24, `automotive:internal` COMPLETED). Next Play upload must be **> 43**; a reuse is refused with `403 Version code N has already been used.`
